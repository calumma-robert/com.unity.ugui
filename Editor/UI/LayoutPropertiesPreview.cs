...
namespace UnityEditor.Events
{
    ...
    class LayoutPropertiesPreview : ObjectPreview
    {
        ...
        public override void OnPreviewGUI(Rect r, GUIStyle background)
        {
            ...
            ShowProp(ref labelRect, ref valueRect, ref sourceRect, "Max Width", LayoutUtility.GetLayoutProperty(rect, e => e.maxWidth, -1f, out source).ToString(CultureInfo.InvariantCulture.NumberFormat), source);
            ShowProp(ref labelRect, ref valueRect, ref sourceRect, "Max Height", LayoutUtility.GetLayoutProperty(rect, e => e.maxHeight, -1f, out source).ToString(CultureInfo.InvariantCulture.NumberFormat), source);
